...
public class TrangChuAdminView extends javax.swing.JFrame {
     ...
     * @param idNV
     */
    public TrangChuAdminView(String idNV) {
        initComponents();
        setLocationRelativeTo(null);
        setVisible(false);
        this.idNV = idNV;
        trangChuServ = new TrangChuServices();
        txtNhanVien.setText("Quản lý:"+trangChuServ.getTenNhanVien(idNV));
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrangChuAdminView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrangChuAdminView("6A72961A-942B-4702-93FE-3AFEE9E49563").setVisible(true);
